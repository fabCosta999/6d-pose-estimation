...
results_dir = "/content/drive/MyDrive/machine_learning_project/eval_results_resnet"
...
weight_path = "/content/drive/MyDrive/machine_learning_project/resnet50/train/weights/best.pth"
